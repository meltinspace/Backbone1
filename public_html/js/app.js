...
directory.Router = Backbone.Router.extend({
    ...
    resellers: function() {
        if (!directory.resellersView) {
            directory.resellersView = new directory.ResellersView();
            directory.resellersView.render();
        }
        this.$content.html(directory.resellersView.el);
        directory.shellView.selectMenuItem('resellers-menu');
    },
...
$(document).on("ready", function() {
    directory.loadTemplates(["HomeView", "ResellersView", "ShellView", "EmployeeView", "EmployeeSummaryView", "EmployeeListItemView"],
            function() {
